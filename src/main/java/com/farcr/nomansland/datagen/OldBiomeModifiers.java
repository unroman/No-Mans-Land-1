...
public class OldBiomeModifiers extends DatapackBuiltinEntriesProvider {
...
//                );
    ...
    public OldBiomeModifiers(PackOutput output, CompletableFuture<HolderLookup.Provider> registries) {
