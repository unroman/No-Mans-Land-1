...
public record PigVariant(ResourceLocation texture, ResourceLocation babyTexture, Optional<HolderSet<Biome>> biomes) {
    ...
    static {
        ...
        CODEC = RegistryFileCodec.create(NMLMobVariants.PIG_VARIANT_KEY, DIRECT_CODEC);
        STREAM_CODEC = ByteBufCodecs.holder(NMLMobVariants.PIG_VARIANT_KEY, DIRECT_STREAM_CODEC);
    }
}
