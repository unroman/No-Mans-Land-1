...
public record SheepVariant(ResourceLocation texture, ResourceLocation babyTexture, ResourceLocation shearedTexture, Optional<HolderSet<Biome>> biomes) {
    ...
    static {
        ...
        CODEC = RegistryFileCodec.create(NMLMobVariants.SHEEP_VARIANT_KEY, DIRECT_CODEC);
        STREAM_CODEC = ByteBufCodecs.holder(NMLMobVariants.SHEEP_VARIANT_KEY, DIRECT_STREAM_CODEC);
    }
}
