...
public record CodVariant(ResourceLocation texture, Optional<HolderSet<Biome>> biomes) {
    ...
    static {
        ...
        CODEC = RegistryFileCodec.create(NMLMobVariants.COD_VARIANT_KEY, DIRECT_CODEC);
        STREAM_CODEC = ByteBufCodecs.holder(NMLMobVariants.COD_VARIANT_KEY, DIRECT_STREAM_CODEC);
    }
}
