...
public record MultiSpreadPatchConfiguration(int tries, int xzSpread, int ySpread, float sparseness, HolderSet<PlacedFeature> features) implements FeatureConfiguration {
