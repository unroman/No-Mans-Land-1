...
public class NMLBiomeModifiers {
    ...
    public static final Supplier<MapCodec<ChangeParticleBiomeModifier>> CHANGE_PARTICLE =
            BIOME_MODIFIERS.register("change_particle", () -> ChangeParticleBiomeModifier.CODEC);
