...
public class NMLDataSerializers {
    ...
    public static final DeferredHolder<EntityDataSerializer<?>, EntityDataSerializer<Holder<PigOverlayVariant>>> PIG_OVERLAY_VARIANT = ENTITY_DATA_SERIALIZERS.register("pig_overlay_variant", () -> EntityDataSerializer.forValueType(PigOverlayVariant.STREAM_CODEC));
