...
public class NMLFogModifiers {
    ...
    public static final DeferredHolder<FogModifier, CaveBiomeFogModifier> CAVE_BIOME_MODIFIER = FOG_MODIFIERS.register("cave_biome_modifier", CaveBiomeFogModifier::new);
}
